...
bcftools mpileup –g 5 -Oz –o /data/data/SRR12701911/gvcf/SRR12701911.gvcf.gz –f /data/data/assembly/GCF_001433935.1_IRGSP-1.0_genomic.fna  /data/data/SRR12701911/sortBam/SRR12701911.sort.bam
